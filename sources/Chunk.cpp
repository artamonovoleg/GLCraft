...
{
    m_Vertices.push_back({ .pos = glm::vec3(0.5, -0.5, -0.5)    + m_Pos + pos, .tex = glm::vec2(2.0f / 16.0f, 1.0f / 16.0f) });
    m_Vertices.push_back({ .pos = glm::vec3(0.5, -0.5, 0.5)     + m_Pos + pos, .tex = glm::vec2(3.0f / 16.0f, 1.0f / 16.0f) });
    m_Vertices.push_back({ .pos = glm::vec3(-0.5, -0.5, -0.5)   + m_Pos + pos, .tex = glm::vec2(2.0f / 16.0f, 0.0f) });
    m_Vertices.push_back({ .pos = glm::vec3(-0.5, -0.5, 0.5)    + m_Pos + pos, .tex = glm::vec2(3.0f / 16.0f, 0.0f) });
...
{
    m_Vertices.push_back({ .pos = glm::vec3(-0.5, 0.5, -0.5)    + m_Pos + pos, .tex = glm::vec2(0, 0) });
    m_Vertices.push_back({ .pos = glm::vec3(-0.5, 0.5, 0.5)     + m_Pos + pos, .tex = glm::vec2(0, 1.0f / 16.0f) });
    m_Vertices.push_back({ .pos = glm::vec3(0.5, 0.5, -0.5)     + m_Pos + pos, .tex = glm::vec2(1.0f / 16.0f, 0) });
